...
namespace tEngine.Recorder
{
    ...
    public class Device
    {
        ...
        private Dictionary<ushort, Action<ushort, HandRawData, HandRawData>> mCallBacks = new Dictionary<ushort, Action<ushort, HandRawData, HandRawData>>();
        ...
        public void AddListener(ushort requestId, Action<ushort, HandRawData, HandRawData> handCallBack)
        {
        ...
        /// </summary>
        /// <param name="handCallBack"></param>
        public void AddListener(Action<ushort, HandRawData, HandRawData> handCallBack) => AddListener(0, handCallBack);
        ...
        public bool NewRequest(ushort requestID)
        {
            ...
            if (DeviceState == DeviceStates.AllRight)
            {
                ...
                byte[] bytes = Packet.PacketToBytes(toDevice);
        ...
        public void RemoveListener(Action<ushort, HandRawData, HandRawData> handCallBack) => RemoveListener(0, handCallBack);

        public void RemoveListener(ushort requestId, Action<ushort, HandRawData, HandRawData> handCallBack)
        {
            if (mCallBacks.ContainsKey(requestId))
                mCallBacks[requestId] -= handCallBack;
        }
