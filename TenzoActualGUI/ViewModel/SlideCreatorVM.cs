...
namespace TenzoActualGUI.ViewModel
{
    ...
    public class SlideCreatorVM : Observed<SlideCreatorVM>
    {
        ...
        public static string OpenDialog()
        {
            ...
            string initPath = AppSettings.GetValue(PlayList.FOLDER_KEY, Constants.AppDataFolder);
        ...
        private void CMDAddImage_Func()
        {
            if (PlayList == null) return;
            string filter = "";
            IEnumerable<string> codecs = ImageCodecInfo.GetImageEncoders().Select(info => info.FilenameExtension);
            string extensions = string.Join(";", codecs.ToArray());
            ...
            string initPath = AppSettings.GetValue(Slide.FOLDER_KEY, Constants.AppDataFolder);
            ofd.InitialDirectory = initPath + @"\";
            if (ofd.ShowDialog() == System.Windows.Forms.DialogResult.OK)
            {
                IsBusyNow = true;
        ...
        private void CMDRemoveSlide_Func()
        {
            ...
            if (SelectedSlide != null)
            {
                if (
                    ...
                    return;
                int index = PlayList.RemoveSlide(SelectedSlide);
        ...
        private void CMDSavePlayList_Func()
        {
            ...
            string initPath = AppSettings.GetValue("LastPlayListFolder", Constants.AppDataFolder);
        ...
        private void CMDToggleGrade_Func()
        {
            ...
            bool now = SelectedSlide.Grade == Slide.SlideGrade.Essential;
