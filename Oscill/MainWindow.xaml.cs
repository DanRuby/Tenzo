...
namespace Oscill
{
    ...
    public partial class MainWindow : Window
    {
        ...
        public MainWindow()
        {
            ...
            DispatcherTimer device = new DispatcherTimer();
        ...
        private void Button_Click(object sender, RoutedEventArgs e)
        {
            ...
            {
                UpdateSettings();
                OxyConst.Model.Axes[0].Minimum = MarkersArea.Minimum;
                OxyConst.Model.Axes[0].Maximum = MarkersArea.Maximum;
            }
        }
        ...
        {
            mCanClear = false;
            IEnumerable<short> leftConst = Data.GetConstBase(Hands.Left);
            IEnumerable<short> leftTremor = Data.GetTremorBase(Hands.Left);
            IEnumerable<short> rightConst = Data.GetConstBase(Hands.Right);
            IEnumerable<short> rightTremor = Data.GetTremorBase(Hands.Right);
            ...
            int d = mConstSeries_Left.Points.Count;
            ...
            OxyConst.Model.InvalidatePlot(true);
            ...
            OxyTremor.Model.InvalidatePlot(true);
